...
class Table(object):
    ...
    def print_table(self, output_name):
    ...
    # ------------------------------------------ TABLES -------------------------------------------
        ...
        for key in self.results:
            df.loc[it] = ['Overall'] + [key[:len_name]] + [self.results[key][index].__format__('.3f') for index in range(32, 40)] + [self.collision_test[key]]
            it += 1
        ...
        ##Type I
        for key in self.results:    
            df.loc[it] = type_list[0] + [key[:len_name]] + [self.results[key][index].__format__('.3f') for index in range(8)]
            it += 1
        ...
        ##Type II
        for key in self.results:  
            df.loc[it] = type_list[1] + [key[:len_name]] + [self.results[key][index].__format__('.3f') for index in range(8, 16)] 
            it += 1        
        ...
        ##Type III
        for key in self.results:  
            df.loc[it] = type_list[2] + [key[:len_name]] + [self.results[key][index].__format__('.3f') for index in range(16, 24)] 
            it += 1
        ...
        ##Type III: LF
        for key in self.results:  
            df.loc[it] = type_list[3] + [key[:len_name]] + [self.sub_results[key][index].__format__('.3f') for index in range(8)] 
            it += 1
        ...
        ##Type III: CA
        for key in self.results:  
            df.loc[it] = type_list[4] + [key[:len_name]] + [self.sub_results[key][index].__format__('.3f') for index in range(8, 16)] 
            it += 1
        ...
        ##Type III: Grp
        for key in self.results:  
            df.loc[it] = type_list[5] + [key[:len_name]] + [self.sub_results[key][index].__format__('.3f') for index in range(16, 24)] 
            it += 1
        ...
        ##Type III: Others
        for key in self.results:  
            df.loc[it] = type_list[6] + [key[:len_name]] + [self.sub_results[key][index].__format__('.3f') for index in range(24, 32)] 
            it += 1
        ...
        ##Type IV
        for key in self.results:  
            df.loc[it] = type_list[7] + [key[:len_name]] + [self.results[key][index].__format__('.3f') for index in range(24, 32)] 
            it += 1
