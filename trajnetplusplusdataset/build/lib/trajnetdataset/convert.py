...
def main():
    ...
    if not args.synthetic:
        ...
        for seq in range(256):
          write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_'+ str(seq_index) +'.csv'),
                'output_pre/{split}/coords_traj_seq_' + str(seq_index) + '.ndjson', args)
          categorize(sc, 'output_pre/{split}/coords_traj_seq_' + str(seq_index) + '.ndjson', args)
          seq_index += 1


        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_0.csv'),
        #       'output_pre/{split}/coords_traj_seq_0.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_0.ndjson', args)
        
        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_1.csv'),
        #       'output_pre/{split}/coords_traj_seq_1.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_1.ndjson', args)

        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_2.csv'),
        #       'output_pre/{split}/coords_traj_seq_2.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_2.ndjson', args)

        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_3.csv'),
        #       'output_pre/{split}/coords_traj_seq_3.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_3.ndjson', args)
        
        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_4.csv'),
        #       'output_pre/{split}/coords_traj_seq_4.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_4.ndjson', args)

        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_5.csv'),
        #       'output_pre/{split}/coords_traj_seq_5.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_5.ndjson', args)

        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_6.csv'),
        #       'output_pre/{split}/coords_traj_seq_6.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_6.ndjson', args)

        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_7.csv'),
        #       'output_pre/{split}/coords_traj_seq_7.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_7.ndjson', args)

        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_8.csv'),
        #       'output_pre/{split}/coords_traj_seq_8.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_8.ndjson', args)

        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_9.csv'),
        #       'output_pre/{split}/coords_traj_seq_9.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_9.ndjson', args)
        
        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_10.csv'),
        #       'output_pre/{split}/coords_traj_seq_10.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_10.ndjson', args)

        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_11.csv'),
        #       'output_pre/{split}/coords_traj_seq_11.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_11.ndjson', args)

        # write(jta(sc, 'data/raw/JTA_data/coords_traj_seq_12.csv'),
        #       'output_pre/{split}/coords_traj_seq_12.ndjson', args)
        # categorize(sc, 'output_pre/{split}/coords_traj_seq_12.ndjson', args)
